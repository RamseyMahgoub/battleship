...
ActiveRecord::Schema.define(version: 2018_10_19_084017) do
  ...
  create_table "grids", force: :cascade do |t|
    ...
    t.index ["game_player_id"], name: "index_grids_on_game_player_id"
  end
  ...
  create_table "ship_cells", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cell_id"], name: "index_ship_cells_on_cell_id"
    t.index ["ship_id"], name: "index_ship_cells_on_ship_id"
  end
